...
router.get("/get", getUsers);// ma route pour la recuperation de tous les users
router.get("/get/:id", verifyToken, getUserById);// ceci est ma route pour la recuperation d'un user par son id

router.put("/update/:id", verifyToken, upload.single("photo"),updateUser);// ceci est ma route pour la modification d'un user par son id
