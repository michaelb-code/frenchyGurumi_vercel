...
router.post("/create", upload.array('image', 5), createArticle);// ceci est ma route pour la creation d'un article
...
router.put("/update/:id", upload.array('image', 5), updateArticle);// ceci est ma route pour la modification d'un article par son id
